...
const shadowHeader = () => {
    ...
    //Add a class if the bottom offset is greater than 50 of the veiwport
...
const scrollUp = () => {
    ...
    //when the scroll is higher than 350 add class
    this.scrollY >= 295 ? scrollUp.classList.add('show-scroll')
